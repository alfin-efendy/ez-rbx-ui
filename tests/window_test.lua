...
h.describe("window", function()
  ...
  h.it("solid chrome, transparent main + translucent content panel", function()
    local R = h.loadLib()
    local w = newWin()
    ...
    local body = w.Main:FindFirstChild("Body")
    h.expect(w.Main:FindFirstChild("TitleBar").BackgroundColor3.R8).toBe(R.Theme.Colors.background.R8)
    h.expect(body:FindFirstChild("SidebarBg").BackgroundColor3.R8).toBe(R.Theme.Colors.background.R8)
